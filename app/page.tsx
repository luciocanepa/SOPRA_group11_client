  ...
  return (
    <div className="landing-page">
      <header>
        ...
        <p>
          A collaborative Pomodoro timer that lets you and your group stay
          focused, take breaks together, and build better work habits -
          collaboratively.
        </p>
      ...
      <main className="content-columns">
        ...
        <div className="carousel-wrapper">
          ...
          <div className="enjoy-box">Enjoy your Time!</div>
      ...
      <div className="group-members">
        <p>
          Group 11: Lucio Canepa, Anna Pang, Sharon Kelly Isler, Moritz Leon
          Böttcher, Helin Capan
        </p>
      </div>
    </div>
  );
